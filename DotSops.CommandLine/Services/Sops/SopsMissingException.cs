...
internal class SopsMissingException : Exception
{
    ...
    public SopsMissingException(string message) : base(message)
    {
    }

    public SopsMissingException(string message, Exception innerException) : base(message, innerException)
    {
    }
}
