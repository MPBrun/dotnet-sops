...
internal class SopsExecutionException : Exception
{
    ...
    public SopsExecutionException(string message) : base(message)
    {
    }

    public SopsExecutionException(string message, Exception innerException) : base(message, innerException)
    {
    }
}
